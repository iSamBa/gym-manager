...
const mockMember: Member = {
  ...
  partnership_company: undefined,
  partnership_type: undefined,
  partnership_contract_start: undefined,
  partnership_contract_end: undefined,
  partnership_notes: undefined,
};
  ...
  it("should get all members", async () => {
    ...
    expect(mockSupabaseClient.rpc).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        p_limit: 20, // Default page size for pagination
        p_offset: 0,
        p_order_by: "name",
